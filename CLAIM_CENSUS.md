...
None. All owned claims are FORCED.
...
| C-208b | Λ value (cosmological constant) | OPEN | K4 at K_cosmo pushes Λ → 0⁺ but does not select a finite value. Cosmological closure deficit is constitutive. |
