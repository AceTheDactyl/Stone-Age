...
**Document Species:** CANONICAL (cross-cutting). Computation as framework dynamics. Canonical theorems C.1–C.12 are first-instance content; remaining sections read existing structure through the computational lens.
